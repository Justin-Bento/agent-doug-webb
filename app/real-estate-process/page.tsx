      ...
      <main className="container mx-auto min-h-dvh px-4 py-5 sm:p-6 my-20">
        <section id="header">
          ...
          <p className="text-base text-balance mt-2 mb-7 dark:text-white">
            Agent Webb provides all the essential information you need to navigate the Real Estate transaction process
            from start to finish, offering unbiased and straightforward insights to help you make informed decisions and
            stay ahead of potential red flags.
          </p>
        </section>
        <section className="grid items-center grid-cols-1 md:grid-cols-2 gap-8 mt-16">
          ...
          />
          <Card Title="More Stuff" Supporting="" URL="/real-estate-process/more-stuff" LinkName="More Information" />
          <Card
  ...
  return (
    <div className="w-full overflow-hidden rounded-lg border bg-card text-card-foreground shadow-sm">
      <div className="px-4 py-6 sm:p-6">
        <h2 className="text-xl font-bold dark:text-white mb-1">{Title}</h2>
