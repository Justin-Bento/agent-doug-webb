          ...
          <div className="container mx-auto px-4 py-5 sm:p-6">
            <div className="bg-white py-24 sm:py-32">
              ...
              <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                <div>
                  <dt className="font-semibold text-gray-900">Push to deploy.</dt>
                ...
                <div>
                  <dt className="font-semibold text-gray-900">SSL certificates.</dt>
                  <dd className="mt-1 text-gray-600">
                ...
                <div>
                  <dt className="font-semibold text-gray-900">Simple queues.</dt>
                  <dd className="mt-1 text-gray-600">
                ...
                <div>
                  <dt className="font-semibold text-gray-900">Advanced security.</dt>
                  <dd className="mt-1 text-gray-600">
                ...
                <div>
                  <dt className="font-semibold text-gray-900">Powerful API.</dt>
                  <dd className="mt-1 text-gray-600">
                ...
                <div>
                  <dt className="font-semibold text-gray-900">Database backups.</dt>
                  <dd className="mt-1 text-gray-600">
